...
// const defaultPath = '../backend/Data/Premises/example_premises.json';
// const defaultErrorPath = '../backend/Data/MergedResults/example_results.json';
// const FACT_CHECK_DATA_PATH='../backend/Data/FactChecked/example_statements.json';

const defaultPath = '../data/case1/structured_cot_8_with_reversed_depth.json';
const defaultErrorPath = '../data/case1/merged_check_results_with_propagation-8.json';
const FACT_CHECK_DATA_PATH='../data/case1/fact_checked_statements-8.json';
